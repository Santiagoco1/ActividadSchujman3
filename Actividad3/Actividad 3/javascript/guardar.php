...
$mysqli = new mysqli($HOST, $USER, $PASS, $DB,$TABLA);
	...
	$mysqli->query("insert into $TABLA (apellido, nombre, fecha_nacimien, dni, domicilio,  
							grupo_sanguineo, factor, peso, altura, email, telefono_fijo, telefono_celu, 
							telefono_altern, enfermedades,   color_fav, talle_zapato)
					values ('".$_POST['apellido']."','".$_POST['nombre'].','"".$_POST['fecha_nacimien'].',
							'"".$_POST['dni']."','".$_POST['domicilio']."',
							'".$_POST['grupo_sanguineo']."','".$_POST['factor']."',
							'".$_POST['peso']."','".$_POST['altura']."','
							'".$_POST['email']."','".$_POST['telefono_fijo']."','".$_POST['telefono_celu']."',
							'".$_POST['telefono_altern']."','".$_POST['enfermedades']."',
							'".$_POST['color_fav']."','".$_POST['talle_zapato']."')");
						
							/*foto_cara, nro_emer, nro_obrasocial, medicamentos,
							'".$_POST['nro_emer']."','".$_POST['nro_obrasocial']."',
