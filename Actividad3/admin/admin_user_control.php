                                ...
                                if( $arreglo[3] == 1){
                                    ...
                                    echo "<td>   
                                            <form action='block_unblock.php' method='post' >
                                                ...
                                                <button class='submit' type='submit' name='enviar' > <img src='../images/bloquear.png'> </button>
                                            </form>
                                        </td>";
                                }
                                else{   
                                    ...
                                    echo "<td>   
                                            <form action='block_unblock.php' method='post' >
                                                ...
                                                <button class='submit' type='submit' name='enviar' > <img src='../images/desbloquear.png'> </button>
                                            </form>
                                        </td>";
                            }
                            echo "</tr>";
